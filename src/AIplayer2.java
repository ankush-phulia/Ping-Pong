...
public  class AIplayer2 {
	...
	public void moveAIplayer(Paddle p,ArrayList<Ball> balls,BoardMulti b,double initialvelocity){
	...
	public void moveAIplayer1(Paddle p,ArrayList<Ball> balls,BoardMulti b,double initialvelocity){
	...
	public void moveAIplayer3(Paddle p,ArrayList<Ball> balls,BoardMulti b,double initialvelocity){
		Ball balltobefollowed = null  ;
		Ball temp  ; 
		double farthestballfromleft = 0;
	...
	public void moveAIplayer4(Paddle p,ArrayList<Ball> balls,BoardMulti b,double initialvelocity){
