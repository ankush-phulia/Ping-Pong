...
public class Options extends JPanel {
    ...
    private String[] Keys2 =
            new String[] {
                "A", "Z", "W", "S", "X", "E", "D", "C", "R", "F", "V", "T", "G", "B", "Y", "H", "N",
                "U", "J", "M", "UP", "DOWN", "Q"
            };
    private String[] Keys3 =
            new String[] {
                "Z", "W", "S", "X", "E", "D", "C", "R", "F", "V", "T", "G", "B", "Y", "H", "N", "U",
                "J", "M", "UP", "DOWN", "Q", "A"
            };
    private String[] Keys4 =
            new String[] {
                "UP", "DOWN", "Q", "A", "Z", "W", "S", "X", "E", "D", "C", "R", "F", "V", "T", "G",
                "B", "Y", "H", "N", "U", "J", "M",
            };
    private String[] Keys5 =
            new String[] {
                "DOWN", "Q", "A", "Z", "W", "S", "X", "E", "D", "C", "R", "F", "V", "T", "G", "B",
                "Y", "H", "N", "U", "J", "M", "UP"
            };
    private String[] Keys6 =
            new String[] {
                "M", "UP", "DOWN", "Q", "A", "Z", "W", "S", "X", "E", "D", "C", "R", "F", "V", "T",
                "G", "B", "Y", "H", "N", "U", "J"
            };
