...
/**
 * The <code>game.RXCardLayout</code> provides some extensions to the CardLayout class. In
 * particular adding support for:
 *
 * <p>a) setting focus on the card when it is displayed b) getting the currently displayed Card c)
 * Next and Previous Actions
 *
 * <p>This added support will only work when a JComponent is added as a Card.
 */
public class RXCardLayout extends CardLayout implements HierarchyListener {
    ...
    /**
     * Creates a new card layout with the specified horizontal and vertical gaps. The horizontal
     * gaps are placed at the left and right edges. The vertical gaps are placed at the top and
     * bottom edges.
     *
