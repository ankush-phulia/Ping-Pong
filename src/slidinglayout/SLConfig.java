...
/**
 * A configuration lets you easily layout the children of a {@link SLPanel}. Its root is a grid,
 * which can have any number of columns and rows. In each col/row pair, you can either place a
 * component, or create a sub-grid. This sub-grid works the same as the first. This powerful layout
 * lets you quickly build great UIs. Gaps between components are customizable, and colums and rows
...
public class SLConfig {
    ...
    /**
     * Sets the global horizontal and vertical gaps between components, in pixels. Default to 0 for
     * both.
     */
    ...
    /**
     * Adds a flexible column to the current grid that will resize according to the application
     * resize events. The relative width that has to be given controls how large the column should
     * be compared to the other flexible columns. Give it "1f" to have every flexible column the
     * same width.
     */
    ...
    /**
     * Adds a flexible row to the current grid that will resize according to the application resize
     * events. The relative height that has to be given controls how large the row should be
     * compared to the other flexible rows. Give it "1f" to have every flexible row the same height.
     */
