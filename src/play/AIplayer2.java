...
public  class AIplayer2 {
	...
	public static void moveAIplayer(Paddle p,ArrayList<Ball> balls,BoardMulti b,double initialvelocity){
	...
	public static void moveAIplayer1(Paddle p,ArrayList<Ball> balls,BoardMulti b,double initialvelocity){
	...
	public static void moveAIplayer3(Paddle p,ArrayList<Ball> balls,BoardMulti b,double initialvelocity){
		Ball balltobefollowed = null  ;
		Ball temp  ; 
		double farthestballfromleft = 0;
